...
export const copyDataFromLocale = async args => {
  ...
  return globalSlug ? await payload.updateGlobal({
    slug: globalSlug,
    data: overrideData ? fromLocaleDataWithoutID : mergeData(fromLocaleData.value, toLocaleData.value, globals[globalSlug].config.fields, req, false),
    locale: toLocale,
    overrideAccess: false,
    req,
    user
    ...
    id: docID,
    collection: collectionSlug,
    data: overrideData ? fromLocaleDataWithoutID : mergeData(fromLocaleData.value, toLocaleData.value, collections[collectionSlug].config.fields, req, false),
    locale: toLocale,
    overrideAccess: false,
    req,
    user
