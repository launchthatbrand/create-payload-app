...
export const DeleteMany = props => {
  ...
  const handleDelete = useCallback(async () => {
    ...
    await requests.delete(`${serverURL}${api}/${slug}${queryString}`, {
      headers: {
  ...
  }, [searchParams, addDefaultError, api, getQueryParams, i18n, plural, router, selectAll, serverURL, singular, slug, t, toggleAll, clearRouteCache, collection]);
