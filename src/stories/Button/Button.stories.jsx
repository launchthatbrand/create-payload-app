...
const SafeButton = withSafeLinks(Button)

/**
 * Button component from @payloadcms/ui/dist/elements/Button
 */
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Button component from @payloadcms/ui/dist/elements/Button',
      },
    },
  },
  argTypes: {
...
/**
 * Primary template for the Button component
 */
const Template = (args) => <SafeButton {...args} />

/**
 * Default state of the Button component
 */
